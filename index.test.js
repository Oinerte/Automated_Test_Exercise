...
test('expect the function to only return active persons ordered by their age', () => {
    app.persons.push(
    ...
    expect(app.getActivePersons()[1].age < app.getActivePersons()[0] && 
        app.getActivePersons()[1].age > app.getActivePersons()[2].age).toBe(true)
    app.persons.pop()
})
